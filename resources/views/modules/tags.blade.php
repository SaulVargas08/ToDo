...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;}
        ...
        .wrapper{max-width:600px;margin:0 auto;padding:32px 20px 60px;}
        ...
        input{background:rgba(255,255,255,0.05);border:1px solid var(--border);border-radius:10px;padding:10px;color:var(--text);}
...
<body>
    <div class="wrapper">
        ...
        <div class="status" id="status">Crear nuevas etiquetas.</div>
        <div class="panel">
            <h2>Crear</h2>
            <form id="formCreate">
    ...
    <script>
        ...
        document.getElementById('formCreate').addEventListener('submit',async e=>{
            ...
            try{ await apiRequest('POST','/api/tags',payload); statusEl.textContent='Etiqueta creada'; e.target.reset(); }
